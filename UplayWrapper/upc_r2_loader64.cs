...
namespace UplayWrapper
{
    public class upc_r2_loader64
    {
        ...
        [DllImport("upc_r2_loader64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "UPC_ProductAddonTrack")]
        public static extern int UPC_ProductAddonTrackImpl(IntPtr inContext, uint inAddonId, IntPtr inOptCallback, IntPtr inOptCallbackData);
        ...
        [DllImport("upc_r2_loader64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "UPC_UserAccountCountryGet")]
        public static extern int UPC_UserAccountCountryGetImpl(IntPtr inContext, [MarshalAs(UnmanagedType.LPUTF8Str)] ref string outCountryCode);
